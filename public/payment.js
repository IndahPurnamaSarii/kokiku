...
                } else {
                    // Jika dokumen tidak ada atau status tidak pending, kembali ke login
                    console.warn('User ada, tapi status tidak valid atau dokumen tidak ada.');
...
            const data = await response.json();
            ...
            // Periksa ulang apakah invoiceUrl ada
            if (!data.invoiceUrl) {
                console.error('ERROR: "invoiceUrl" tidak ditemukan di dalam respons:', data);
                throw new Error('Server tidak mengembalikan invoiceUrl.');
            }
